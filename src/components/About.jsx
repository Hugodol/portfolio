...
class About extends Component {
  ...
  scrollClickApps() {
    TweenLite.to(window, .8, {scrollTo: '.projects'});
  }

  scrollClickSkills() {
    TweenLite.to(window, .8, {scrollTo: '.skills'});
  }
